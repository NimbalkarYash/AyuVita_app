            ...
            <div className="bg-white rounded-2xl shadow-md p-6 border border-gray-100 space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <a
                    href="https://www.acc.org/-/media/Non-Clinical/Files-PDFs-Excel-MS-Word-etc/Tools-and-Practice-Support/Risk-Communications/3-Explaining-ASCVD-Risk-Scores-for-Primary-Prevention.pdf"
